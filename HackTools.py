...
## Update 0.4 alfa #
#!!!!!!!!! Внимание мамкиным копипастерятам, в обновлении 0.4 alfa был добавлен эксплоит ##
...
print(Fore.WHITE+f"Ссылка - {Fore.GREEN}https://teleg.run/hacktools666"+Style.RESET_ALL)
print(Fore.WHITE+f"Имя канала для поиска - {Fore.GREEN}@hacktools666"+Style.RESET_ALL)
...
if POL == "y":
	...
	if POLL == "y":
		...
		print(Fore.WHITE+f"{Back.GREEN}Для участников Alfa теста - Логин: {Fore.YELLOW}x11repo {Fore.WHITE}Пароль: {Fore.YELLOW}alfa"+Style.RESET_ALL)
		def get_log_passw():
			return ("x11repo", "alfa")
		def gogogo():
			def menu(selected = ""):
				...
				if(selected == ""):
					...
					print(Fore.GREEN+f"{Style.RESET_ALL}Ver: 0.4 alfa")
					print(Fore.BLUE+f"{Fore.BLUE}======================================")
					print(Fore.GREEN+f"{Style.RESET_ALL}{Fore.RED}[!]{Style.RESET_ALL} Перед использованием установите все репозитории!\n Для этого введите {Fore.GREEN}999")
					print(Fore.BLUE+f"======================================")
					time.sleep(1)
